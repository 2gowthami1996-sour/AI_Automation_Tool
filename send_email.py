...
def append_unsubscribe_link(body_text, recipient_email):
    ...
    unsubscribe_link = f"\n\n---\nIf you prefer not to receive future emails, you can unsubscribe here: https://aiautomationtool-9criyayngv3srzouygnaiy.streamlit.app/unsubscribe?email={quote(recipient_email)}"
